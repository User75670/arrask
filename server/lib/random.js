...
exports.chooseBotName = () => {
    return exports.choose([ "Lets be friends", "Bob", "Hello", "SpaceUK", "Abc", "What", "Key", "123", "Geometry Dash", "Arras.io", "<<<Tidal<<< >>>Wave>>>", "Dev pls", "Peter", "1+1=3", "Idk", "Zoink", "Riot", "Cyclic", "Are you okay?", "How", "Whyyyyyyyyy", "Yes", "Zachary", "Alpha", "Bravo", "Rubrub", "Delta", "Echo", "Foxtrot", "RobTop", "Chocolate", "I love geometry dash", "Hello Guys", "EricVanWilderman", "Mike", "YT", "Who are you", "Hey you", "Quebec", "I'm smart😎", "Hey", "Tango", "Milk", "Rainbow", "No", "X-Ray", "Y-Ray", "Cookie" ])
}
exports.chooseBossName = code => {
    switch (code) {
        ...
        case "K":
            return exports.choose([ "Key" ]);
        case "T":
            return exports.choose([ "Triangl-E" ]);
    }
}