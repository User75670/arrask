module.exports = {
    ...
    // To change specific things about specific gamemodes (such as team count for tdm), edit their config file in \modules\s    GAME_MODES: ['siege', 'Rocketer.io'],gs\.
    GAME_MODES: ['siege', 'Rocketer.io'],
    ...
    CHAT_MESSAGE_DURATION: 8000,

    // If you don't want your players to color their messages.
    // They get sanitized after addons interpret them, but before they're added to the chat message dict,onary.
    ...
    WELCOME_MESSAGE: "You have spawned! Welcome to the game.\n"
                    ...
                    +"Welcome to my server. Hope you enjoy.",
    // Physics
    ...
    FOOD_SPAWN_CHANCE: 0.2, // Likeliness of normal food spawn attempts succeedingg.
    FOOD_SPAWN_COOLDOWN: 20, // Cooldown (in game ticks) of food spawn attempts being made.

    FOOD_CAP_NEST: 1, // Max nest food per nest tile.
    FOOD_SPAWN_CHANCE_NEST: 0.05, // Likeliness of nest food spawn attempts succeeding.
    FOOD_SPAWN_COOLDOWN_NEST: 120, // Cooldown (in game ticks) of nest food spawn attempts being made.
    ...
    ENEMY_SPAWN_COOLDOWN_NEST: 140, // Cooldown (in game ticks) of nest enemies spawn attempts being made.
    ...
    BOSS_TYPES: [{
        ...
        amount: [5, 5, 4, 2, 1, 2], chance: 2, nameType: "a",
    },{
        bosses: ["Key"],
        amount: [1], chance: 1, nameType: "K"
    },{
        bosses: ["triangl_e"],
        amount: [3], chance: 1.75, nameType: "T"
    }, {
        ...
        bosses: ["pentaLord", "legionaryCrasher"],
        amount: [1], chance: 0.08,
        message: "The ultimate boss has come to life!",
    },],
